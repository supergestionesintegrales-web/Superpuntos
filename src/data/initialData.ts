...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod_bono_100k',
    name: 'Bono $100.000 COP',
    description: 'Bono de dinero en efectivo para redimir en saldo disponible.',
    category: 'Bonos',
    pointsCost: 70,
    stock: 100,
    imageUrl: '',
    brand: 'SuperGIROS',
    specifications: ['Acreditación inmediata de dinero', 'Redimible en saldo disponible', 'Sin fecha de vencimiento'],
    isDigital: true,
    isFeatured: true,
    active: true,
    createdAt: '2025-01-10T10:00:00Z'
