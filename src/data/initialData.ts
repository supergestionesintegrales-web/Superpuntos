...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr_ally_drogueria_la14',
    name: 'Droguería & Variedades La 14',
    documentId: '1113456789',
    email: 'drogueria14@superpuntos.com',
    phone: '3124567890',
    role: 'ally',
    password: 'Aliado2026!',
    zone: 'Cali Centro',
    ...
    totalPointsEarned: 0,
    totalPointsRedeemed: 0,
    avatarUrl: 'https://ui-avatars.com/api/?name=Drogueria+La+14&background=0284c7&color=fff&bold=true',
    status: 'active',
    createdAt: '2025-01-05T08:00:00Z',
    businessName: 'Droguería La 14 - Punto Comercial Cali'
  },
  {
    id: 'usr_ally_punto_centro',
    name: 'Punto Comercial SuperGIROS Centro',
    documentId: '1098765432',
    email: 'puntocentro@superpuntos.com',
    phone: '3156789012',
    role: 'ally',
    password: 'Aliado2026!',
    zone: 'Palmira',
    ...
    totalPointsEarned: 0,
    totalPointsRedeemed: 0,
    avatarUrl: 'https://ui-avatars.com/api/?name=Punto+Centro&background=059669&color=fff&bold=true',
    status: 'active',
    createdAt: '2025-01-06T08:00:00Z',
    businessName: 'SuperGIROS Centro Palmira'
  },
  {
    id: 'usr_ally_multiservicios',
    name: 'Multiservicios El Trébol',
    documentId: '1114567890',
    email: 'eltrebol@superpuntos.com',
    phone: '3178901234',
    role: 'ally',
    password: 'Aliado2026!',
    zone: 'Yumbo',
    ...
    totalPointsEarned: 0,
    totalPointsRedeemed: 0,
    avatarUrl: 'https://ui-avatars.com/api/?name=Multiservicios+Trebol&background=d97706&color=fff&bold=true',
    status: 'active',
    createdAt: '2025-01-07T08:00:00Z',
    businessName: 'Multiservicios El Trébol Yumbo'
  },
  {
    id: 'usr_ally_distribuidora',
    name: 'Comercializadora & Servicios del Valle',
    documentId: '1115678901',
    email: 'serviciosvalle@superpuntos.com',
    phone: '3167890123',
    role: 'ally',
    password: 'Aliado2026!',
    zone: 'Jamundí',
    ...
    totalPointsEarned: 0,
    totalPointsRedeemed: 0,
    avatarUrl: 'https://ui-avatars.com/api/?name=Servicios+Valle&background=7c3aed&color=fff&bold=true',
    status: 'active',
    createdAt: '2025-01-08T08:00:00Z',
    businessName: 'Servicios del Valle Jamundí'
  },
  {
    id: 'usr_ally_estanco_sanjuan',
    name: 'Estanco y Papelería San Juan',
    documentId: '1116789012',
    email: 'sanjuan@superpuntos.com',
    phone: '3189012345',
    role: 'ally',
    password: 'Aliado2026!',
    zone: 'Buenaventura',
    ...
    totalPointsEarned: 0,
    totalPointsRedeemed: 0,
    avatarUrl: 'https://ui-avatars.com/api/?name=Estanco+San+Juan&background=e11d48&color=fff&bold=true',
    status: 'active',
    createdAt: '2025-01-09T08:00:00Z',
    businessName: 'Estanco San Juan Buenaventura'
  }
];
...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    pointsCost: 10,
    stock: 50,
    imageUrl: '/products/kit-supergiros.png',
    brand: 'SuperGIROS',
  ...
  },
  {
    ...
    pointsCost: 25,
    stock: 35,
    imageUrl: '/products/gafas-mundialistas.png',
  ...
  },
  {
    ...
    pointsCost: 45,
    stock: 20,
    imageUrl: '/products/olla-presion.png',
    brand: 'Hogar & Cocina',
  ...
  },
  {
    ...
    pointsCost: 70,
    stock: 100,
    imageUrl: '/products/bono-100k.svg',
  ...
  },
  {
    ...
    pointsCost: 100,
    stock: 100,
    imageUrl: '/products/bono-150k.svg',
    brand: 'App SuperGiros',
    specifications: [
      'Cargado directamente a la App SuperGiros',
      'Acreditación de saldo en la cuenta del Aliado',
